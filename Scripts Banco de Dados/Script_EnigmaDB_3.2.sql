...
@Usaurio int
as
Insert into Texto values (@Tamanho,@Cor,@Conteudo,@Negrito,@Italico,@Usaurio)
go
...
@Usaurio int
as
Update Texto set Tamanho_Texto = @Tamanho, Cor_Texto = @Cor,Conteudo_Texto = @Conteudo,Negrito_Texto = @Negrito, Italico_Texto = @Italico, ID_Usuario = @Usaurio
where ID_Texto = @ID
go
------------------------------------------------------------------------------------------------------------------------------------
--Tabela Video
